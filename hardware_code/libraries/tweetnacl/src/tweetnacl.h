...
typedef i64 gf[16];
extern int unpackneg_zip215(gf r[4], const unsigned char p[32]);

int crypto_sign_ed25519_sui_detached(unsigned char *sig, const unsigned char *digest, const unsigned char *sk);
